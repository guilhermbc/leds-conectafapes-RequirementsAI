Feature: Gerenciar Modulo

Scenario Outline: Eu, como Usuário Autenticado, quero cadastrar um(a) Modulo
...
Scenario Outline: Eu, como Usuário Autenticado, quero atualizar a Modulo
...
Scenario Outline: Eu, como Usuário Autenticado, quero buscar a Modulo

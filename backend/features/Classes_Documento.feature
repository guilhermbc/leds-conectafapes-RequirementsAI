Feature: Gerenciar Documento

Scenario Outline: Eu, como Usuário Autenticado, quero cadastrar um(a) Documento
...
Scenario Outline: Eu, como Usuário Autenticado, quero atualizar a Documento
...
Scenario Outline: Eu, como Usuário Autenticado, quero buscar a Documento

    ...
    if st.button(" Enviar para análise"):
        ...
        try:
            ...
            try:
                ...
                data = { "project" : { "name" : "RequirementsAi", "version" : "0.3.0"}}
            ...
            if response.status_code == 200:
                ...
                st.download_button('Dowload Diagrama de Classe', class_diagram + footer, file_name="classDiagram.md", on_click='ignore')
